...
/* hier declareer ik de functie*/ async function fetchCountries() {
    try {
        /* Hier wordt de lijst weergeven vanuit de API en heet nu Response ----*/ const response = await _axiosDefault.default.get('https://restcountries.com/v2/all');
        /* ----------Toevoegen van Land vlag!----------*/ // let flagland = response.data[1].flag;
        ...
        /*----------Toevoegen van eerste tekst ---- */ //Hier zorg ik er voor dat de element country list wordt aangesproken
        ...
        countryDetail.innerHTML = `<li> Land : ${response.data[1].name}</li>`;
        // En voeg ik deze aan de parent toe.
        countriesList.appendChild(countryDetail);
        /* ----------Hier voeg ik de tweede tekst toe---------*/ const countryDetail2 = document.createElement("li");
        countryDetail2.innerHTML = `<li> Has a population of ${response.data[0].population} people </li>`;
        countriesList.appendChild(countryDetail2);
    /* -------- Dis is de standaard error tekst -------*/ } catch (e) {
        console.log(e);
...
1.Hoe krijg ik per land een nette array met daarin landnaam en populatie en links in de hoek een vlag?
   ...
   D.
   */ /* een nieuwe lijst maken die de landen mapt van populatie laag naar groot */ async function OrderArrayPopulation() {
    try {
...
1. Ik heb de functie klaarstaan die de geordende lijst ook geeft;----
 2.Ik de */ //Hier roep ik de functie op die de array heeft geordend.
...
async function getRegion() {
    try {
        ...
        if (regionLand === "Europe") console.log("ik ben europees");
